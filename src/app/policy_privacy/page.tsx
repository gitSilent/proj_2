					...
					<section className="flex items-start flex-col justify-center gap-[50px]">
						...
						<div className="">
							...
							<p className="text-[#2D2D2D]  md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
								...
								<br /> 1.2. Настоящая политика Оператора в отношении обработки персональных данных (далее — Политика) применяется ко всей информации, которую Оператор может получить о посетителях веб-сайта https://myinspira.ru/.
							</p>
						</div>

						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">2. Основные понятия, используемые в Политике</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
								...
								<br /> 2.3. Веб-сайт — совокупность графических и информационных материалов, а также программ для ЭВМ и баз данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://myinspira.ru/.
								...
								<br /> 2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному или определяемому Пользователю веб-сайта https://myinspira.ru/.
								...
								<br /> 2.10. Пользователь — любой посетитель веб-сайта https://myinspira.ru/.
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">2. Основные права и обязанности Оператора</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">3. Основные права и обязанности субъектов персональных данных</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">5. Принципы обработки персональных данных</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">6. Цели обработки персональных данных</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
								<table className=''>
									<div className="flex py-[10px]">
										<th className='border min-w-[200px] max-w-[200px] xs:max-sl:min-w-[100px] xs:max-sl:max-w-[100px] py-[5px]'>Цель обработки</th>
										<tr className='border w-full p-[5px]'><td>информирование Пользователя посредством отправки электронных писем</td></tr>
									</div>
									<div className="flex py-[10px]">
										<th className='border min-w-[200px] max-w-[200px] xs:max-sl:min-w-[100px] xs:max-sl:max-w-[100px] py-[5px]'>Персональные данные</th>
										<tr className='border w-full p-[5px]'><td>• фамилия, имя, отчество
											<br />•	электронный адрес
											<br /> • номера телефонов
										</td></tr>
									</div>
									<div className="flex py-[10px]">
										<th className='border min-w-[200px] max-w-[200px] xs:max-sl:min-w-[100px] xs:max-sl:max-w-[100px] py-[5px]'>Правовые основания</th>
										<tr className='border w-full p-[5px]'><td>• Федеральный закон «Об информации, информационных технологиях и о защите информации» от 27.07.2006 N 149-ФЗ</td></tr>
									</div>
									<div className="flex py-[10px]">
										<th className='border min-w-[200px] max-w-[200px] xs:max-sl:min-w-[100px] xs:max-sl:max-w-[100px] py-[5px]'>Виды обработки персональных данных</th>
										<tr className='border w-full p-[5px]'><td>• Сбор, запись, систематизация, накопление, хранение, уничтожение и обезличивание персональных данных
											<br /> •	Отправка информационных писем на адрес электронной почты</td></tr>
									</div>
								</table>
							</p>
						</div>
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">7. Условия обработки персональных данных</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">8. Порядок сбора, хранения, передачи и других видов обработки персональных данных</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
								...
								<br /> 8.3. В случае выявления неточностей в персональных данных, Пользователь может актуализировать их самостоятельно, путем направления Оператору уведомление на адрес электронной почты Оператора info@myinspira.ru с пометкой «Актуализация персональных данных».
								...
								<br />  Пользователь может в любой момент отозвать свое согласие на обработку персональных данных, направив Оператору уведомление посредством электронной почты на электронный адрес Оператора info@myinspira.ru с пометкой «Отзыв согласия на обработку персональных данных».
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">9. Перечень действий, производимых Оператором с полученными персональными данными</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">10. Трансграничная передача персональных данных</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">11. Конфиденциальность персональных данных</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
						...
						<div className="">
							<h2 className="md:text-[24px] xs:text-xl font-black tracking-tighter mb-[15px]">12. Заключительные положения</h2>
							<p className="text-[#2D2D2D] md:text-base xs:text-[12px] md:leading-[23px] xs:leading-[16px]">
								12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его персональных данных, обратившись к Оператору с помощью электронной почты info@myinspira.ru.
								...
								<br /> 12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу <Link href="/policy_privacy" className='underline'>https://myinspira.ru/policy_privacy</Link>
