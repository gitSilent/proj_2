...
export default function ContactsMobileFooter({ contacts }: IProps) {
		...
		<div className="bg-[#2D2D2D] text-white">
			...
			<div className="">
				<div className="">
					<YMaps>
						<div className=''>
							<Map defaultState={{ center: [55.75, 37.57], zoom: 15 }} width={`100vw`} height={`60vh`} />
						</div>
					</YMaps>
				</div>
				...
				<div className="pt-[50px] pb-[30px] px-[20px] max-w-[375px] relative">
					...
					<div className="flex flex-row justify-between items-start gap-[71px] z-[1]">
						...
						<div className="flex flex-col items-start gap-[20px] z-[1]">
							...
							<Link href={"/products"} className="block text-[16px] tracking-[-0.03em] leading-[20.8px] uppercase font-medium text-white hover:text-[#e3e3e3] hover:cursor-pointer duration-100">Каталог</Link>
							<Link href={"/reviews"} className="block text-[16px] tracking-[-0.03em] leading-[20.8px] uppercase font-medium text-white hover:text-[#e3e3e3] hover:cursor-pointer duration-100">Отзывы</Link>
							...
							<Link href={"/"} className="block text-[16px] tracking-[-0.03em] leading-[20.8px] uppercase font-medium text-white hover:text-[#e3e3e3] hover:cursor-pointer duration-100">FAQ</Link>
						</div>
						...
						<div className="">
							...
							<div className="flex items-start justify-start gap-[40px] mb-[30px] z-[1] relative">
								<div className="font-normal text-[12px] leading-[15.6px] tracking-[-0.03em]">
									...
									<span onClick={() => setIsModalContactUsActive(true)} className="block uppercase underline font-medium text-[10px] leading-[12.55px] tracking-[-0.03em] mt-[15px]">Связаться с нами</span>
								</div>
							</div>
						</div>
