...
export default function CatalogComponentTwo({ products }: IProps) {
        ...
        <div className="xs:max-md:mb-[70px] xs:max-md:mt-[50px] mb-[125px] mt-[225px] mx-auto relative overflow-x-hidden">
            <div className="">
                <div className="mx-auto max-w-[1220px] w-full px-[20px] mb-[30px] lx:relative">
                    <div className="prevSpan relative leading-[27px] lx:absolute -top-[6px] xs:pt-[10px]">
                        <span className="block">Часто <br className='xs:max-lx:hidden' /> заказывают</span>
                        <span className="absolute hidden xs:max-lx:block tracking-[-0.03em]  xs:left-[171px] xs:text-[12px]/[15] md:top-[5px] xs:-top-[75px] md:left-[215px] md:text-[16px]/[20.8px] ">{products.length}</span>
                    </div>
                </div>
