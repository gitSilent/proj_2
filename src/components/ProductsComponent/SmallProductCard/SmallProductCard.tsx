...
export default function SmallProductCard({item}:IProps) {
  ...
  return (
    <Link href={`/products/${item.id}`}>
        ...
        <div className="xs:max-w-[342px] lx:max-w-[380px] w-full cursor-pointer relative z-10">
            <div className='relative'>
                <Image  width={342} height={226} src={selectedPhoto ? selectedPhoto : item.photos[0].photo} alt="swiper img" className="xs:min-w-[342px] xs:max-w-[342px] xs:h-[226px] lx:h-[250px] lx:min-w-[380px] object-cover" />
